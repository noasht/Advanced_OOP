...
public class Sys {
	...
	public static void CreateMenu(int numberOfAnimals, Scanner scanner) {
		Animal[] Arr = new Animal[numberOfAnimals];
		for (int i = 0; i < numberOfAnimals; i = i + 1) {
			Arr[i] = CreatAnimal(scanner);
		}
...
*/
     ...
     */
	public static int SpeedFun(Scanner scanner) {
		int speed = -1;
		do {
     ...
     *
     * @param scanner The Scanner object used to read user input.
     * @return The toxicity level of the snake's venom as a SnakeToxicityLevel enum value (LOW, MEDIUM, or HIGH).
     */
	public static SnakeToxicityLevel SnakeToxicityLevelFun(Scanner scanner) {
		...
		switch (choice) {
		case 1: {
			PoisonLevel = SnakeToxicityLevel.LOW;
			break;
		}
		case 2: {
			PoisonLevel = SnakeToxicityLevel.MEDIUM;
			break;
		}
		case 3: {
			PoisonLevel = SnakeToxicityLevel.HIGH;
			break;
		}
		}
		return PoisonLevel;
     ...
     */
	/*
	public static Eagle createEagle(String name, Genders gender, double weight, int speed, Medal[] medals,
	...
	*/
     ...
     */
	/*
	public static Pigeon createPigeon(String name, Genders gender, double weight, int speed, Medal[] medals,
	...
	*/
     ...
     */
	/*
	public static Alligator createAlligator(String name, Genders gender, double weight, int speed, Medal[] medals,
	...
	*/
     ...
     */
	/*
	public static Whale createWhale(String name, Genders gender, double weight, int speed, Medal[] medals,
	...
	*/
     ...
     */
	/*
	public static Dolphin createDolphin(String name, Genders gender, double weight, int speed, Medal[] medals,
	...
	*/
     ...
     */
	/*
	public static Dog createDog(String name, Genders gender, double weight, int speed, Medal[] medals,
	...
	*/
     ...
     */
	/*
	public static Cat createCat(String name, Genders gender, double weight, int speed, Medal[] medals,
	...
	*/
     ...
     */
	/*
	public static Snake createSnake(String name, Genders gender, double weight, int speed, Medal[] medals,
