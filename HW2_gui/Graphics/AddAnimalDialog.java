...
public class AddAnimalDialog extends JDialog {
	...
	private void addRadioButtonListeners(Vector<String> selectedCompetition) {
		String TerrestrialAnimals = "Terrestrial animals";
		String WaterAnimals = "Water animals";
		String AirAnimals = "Air animals";
	...
	private void handleAnimalSelection(Vector<String> selectedCompetition, String animalType) {
		if (!selectedCompetition.contains(animalType)) {
			JOptionPane.showMessageDialog(null, "There is no existing competition for the selected type of animal");
	...
	private void openAnimalDetailsDialog(JFrame parent, String selectedAnimal, Vector<Animal> AnimalsCreated) {
		...
		} else if (selectedAnimal.equals("Dolphin") || selectedAnimal.equals("Whale")
				|| selectedAnimal.equals("Alligator")) {
	...
	private void handleOkAnimalDetailsButton(Vector<Animal> AnimalsCreated) {
		try {
			...
			if (!selectedAnimal.equals("Dog") && !selectedAnimal.equals("Cat") && !selectedAnimal.equals("Snake")) {
				...
				pointAnimalPoint = new Point(0, 0);
	...
	private Point TrackPoolPosition(int choice) {
		...
		if (selectedAnimal.equals("Pigeon") || selectedAnimal.equals("Eagle")) {
			PointAnimal = new Point(Drawable.SIZE_PICTURE*2,(choice - 1 ) *Drawable.SIZE_PICTURE*2 - 10);
			return PointAnimal;
		}

		PointAnimal = new Point(Drawable.SIZE_PICTURE*2, (2*choice - 1) * Drawable.SIZE_PICTURE);
		return PointAnimal;
	}
	/**
