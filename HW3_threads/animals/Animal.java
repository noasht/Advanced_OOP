...
public abstract class Animal extends Mobile implements ILocatable, IMoveable,IDrawable, IClonable  {
	...
	public boolean eat(int energy) {
		if (energy > 0 && ((this.energyAmount + energy) <= this.maxEnergy)) {
	...
	public boolean setOrien() {
		if(this.orien == Orientation.EAST) {
			this.orien = Orientation.SOUTH;
		}
		else if(this.orien == Orientation.SOUTH) {
			orien = Orientation.WEST;
		}
		else if(this.orien == Orientation.WEST) {
			orien = Orientation.NORTH;
		}
		else if(this.orien == Orientation.NORTH) {
			orien = Orientation.EAST;
		}
		this.iDrawable.setOrien();
		return true;
	}
	public boolean SetOrientation(Orientation o) {
		this.orien = o;
		this.iDrawable.SetOrientation(o);
		return true;
	}
	...
	public boolean SetFinishLine(Point Other ) {
		return this.FinishLine.SetPoint(Other);
	}	
}
